  ...
  return (
    <>
          ...
          <div className="carousel-inner">
            <div className="carousel-item active">
              <a className='aVideo' href="https://donaronline.org/fundacion-casa-de-jesus/10-aniversario-fundacion-casa-de-jesus?preview=true" target='_blank'>
                <img src="/img/B_Slider01.png" className="d-block w-100" alt="Slider1" />
              </a>
            </div>
            <div className="carousel-item">
              <a className='aVideo' href="#obras">
                <img src="/img/B_Slider02.png" className="d-block w-100" alt="Slider2" />
              </a>
            </div>
            <div className="carousel-item">
      ...
      <section className='aporte'>
        ...
        <a href="https://www.indec.gob.ar/uploads/informesdeprensa/ipc_07_24C42AFC489C.pdf" target='_blank'>Conócelo</a>
      </section>
      <section>
        <h2 id='obras'>Obras</h2>
        <div className='obras'>
          <div className='divObra'>
            <img src="/img/C_SANFRANCISCO.png" alt="Hogar San Francisco" />
          ...
          <div className='divObra'>
            <img src="/img/C_SANTATERESITA.png" alt="Hospice Santa Teresita" />
            <div className='obrasContenido'>
